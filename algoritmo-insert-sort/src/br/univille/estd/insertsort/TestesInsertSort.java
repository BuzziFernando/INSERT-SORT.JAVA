...
public class TestesInsertSort {

	
	@Test
	void exercicio01() {
		int a[] = {4,2,-9,78,8};
		int retorno[] = InsertSort.exercicio01(a);
		int esperado[] = {-9,2,4,8,78};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		int b[] = {0,2,1,1,2};
		retorno = InsertSort.exercicio01(b);
	...
	void exercicio02() {
		int a[] = {4,2,-9,78,8};
		int retorno[] = InsertSort.exercicio02(a);
		int esperado[] = {78,8,4,2,-9};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		int b[] = {0,2,1,1,2};
		retorno = InsertSort.exercicio02(b);
	...
	void exercicio03() {
		...
		String retorno[] = InsertSort.exercicio03(entrada);
		String esperado[] = {"a","b","c","z"};
		assertArrayEquals(esperado,retorno,"O vetor deve estar ordenado");
		String entrada2[] = {"k","m","e","b"};
		String retorno2[] = InsertSort.exercicio03(entrada2);
	...
	void exercicio04() {
		...
		Produto retorno[] = InsertSort.exercicio04(entrada);
	...
	void exercicio05() {
		Produto entrada[] = {new Produto("Tenis Nike",299.99)
							...
							,new Produto("Tenis Adida",227.99)
							,new Produto("Camisa Polo",99.99)};
		Produto retorno[] = InsertSort.exercicio05(entrada);
